...
public class EjercicioRepaso6 {
	...
	private void initialize() {
		...
		labelDestinos.setBounds(234, 54, 227, 14);
		...
		ActionListener botonAparece = new ActionListener() {
		...
		seleccionarBut.addActionListener(botonAparece);
		comboBox.addActionListener(botonAparece);
	}
}
