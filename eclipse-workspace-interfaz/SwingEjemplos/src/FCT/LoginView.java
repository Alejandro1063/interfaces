...
public class LoginView extends View {
	...
	public LoginView(AppController appController) {
		...
		emailLabel.setBounds(83, 83, 46, 14);
		add(emailLabel);

		textFieldEmail = new JTextField();
		textFieldEmail.setBounds(83, 107, 173, 20);
		add(textFieldEmail);
		...
		buttonEntrar.setBounds(124, 210, 89, 23);
		add(buttonEntrar);
		...
		passwordField.setBounds(83, 161, 173, 21);
		add(passwordField);
		...
		ActionListener login = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getSource() == buttonSalir) {
					if (JOptionPane.showConfirmDialog(buttonSalir, "¿Seguro que quieres salir?", "¿Cerrar programa?",
